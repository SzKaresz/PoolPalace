<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $update_stmt = $db -> prepare("UPDATE felhasznalok
                                    ...
                                    WHERE felhasznalok.email = ?");
        $update_stmt -> bind_param("ssssssssss", $nev, $uj_email, $telefonszam, $szallitasi_irsz, $szallitasi_telepules, $szallitasi_utca,
                                                $szamlazasi_irsz, $szamlazasi_telepules, $szamlazasi_utca, $email);
        $update_stmt -> execute();
        $update_stmt -> close();
